...
import 'tv.dart' as _i4;
import 'package:tv_applications_client/src/protocol/movie.dart' as _i5;
import 'package:tv_applications_client/src/protocol/tv.dart' as _i6;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i4.Tv) {
      return _i4.Tv.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i4.Tv?>()) {
      return (data != null ? _i4.Tv.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<List<_i3.Movie>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i3.Movie>(e)).toList()
          : null) as T;
    }
    if (t == List<_i5.Movie>) {
    ...
    if (t == List<_i6.Tv>) {
      return (data as List).map((e) => deserialize<_i6.Tv>(e)).toList() as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'Tv') {
      return deserialize<_i4.Tv>(data['data']);
    }
